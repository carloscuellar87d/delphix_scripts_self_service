...
#
# Usage
#   python api_create_bookmark.py <DELPHIX_ADMIN> <PASSWORD> <DELPHIX_ENGINE> <TEMPLATE_NAME> <CONTAINER_NAME> <BRANCH_NAME> <BOOKMARK_NAME> <POINT_IN_TIME> <BOOKMARK_OPERATION>
#
#
# Example
#   python api_create_bookmark.py admin delphix delphixengine test1 testc1 branch1 carlos_test_2 2019-08-22T20:15:00.000Z CREATE
#================================================================================
#
import sys
import requests
...
if DX_CREATE_DELETE == "CREATE":
    ...
    if DX_ACT_BRANCH_REF == DX_BRANCH_REF:
        if DX_BM_TIME == "CURRENT_TIME":
            formdata = '{ "type": "JSBookmarkCreateParameters" , "bookmark": { "type": "JSBookmark", "name": "' + DX_BOOKMARK + '" ,  "branch": "' + DX_BRANCH_REF + '" }, "timelinePointParameters": { "type": "JSTimelinePointLatestTimeInput", "sourceDataLayout": "' + DX_CONTAINER_REF + '" } }'
        else:
            #
            # Create JSON format parameters for API call to create Delphix Self Service Bookmark
            #
            formdata = '{ "type": "JSBookmarkCreateParameters" , "bookmark": { "type": "JSBookmark", "name": "' + DX_BOOKMARK + '" ,  "branch": "' + DX_BRANCH_REF + '" }, "timelinePointParameters": { "type": "JSTimelinePointTimeInput", "time": "' + DX_BM_TIME + '", "branch": "' + DX_BRANCH_REF + '" } }'
            #
